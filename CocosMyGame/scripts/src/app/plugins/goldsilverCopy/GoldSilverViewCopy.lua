local GoldSilverViewCopy = cc.load("ViewAdapter"):create()

GoldSilverViewCopy.PATH_NODE_AWARDITEM = "res/hallcocosstudio/goldsilverCopy/goldsilveritemCopy.csb"

GoldSilverViewCopy.viewConfig = {
    "res/hallcocosstudio/goldsilverCopy/goldsilverCopy.csb",
    {
