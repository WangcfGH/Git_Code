local GoldSilverBuyLayerView = cc.load("ViewAdapter"):create()

GoldSilverBuyLayerView.viewConfig = {
    "res/hallcocosstudio/goldsilver/goldsilverbuylayer.csb",
    {
