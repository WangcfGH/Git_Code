...
function viewCreator:onCreateView(viewNode)
    ...
    --隐藏现金模式下的图片
    viewNode.imgRMB:setVisible(false)    
    viewNode.imgRMBTruth:setVisible(false)
    -- 已完成列表符号替换
    for k=1, 3 do
        local imgFlagName = "spriteFlag"..k
        viewNode[imgFlagName]:setSpriteFrame("hallcocosstudio/images/plist/RedPack100Vocher/small_vocher.png")
    end

    --  按钮图片替换
    viewNode.spriteBreak:setSpriteFrame("hallcocosstudio/images/plist/RedPack100Vocher/get_vocher3.png")
    viewNode.spriteReward:setSpriteFrame("hallcocosstudio/images/plist/RedPack100Vocher/duihuanliquan.png")
    viewNode.spriteLoginTip:setSpriteFrame("hallcocosstudio/images/plist/RedPack100Vocher/tommrow_login.png")
end
