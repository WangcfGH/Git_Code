local RedPack100SimpleCtrl = class('RedPack100SimpleCtrl', cc.load('BaseCtrl'))
local viewCreater       = import("src.app.plugins.RedPack100.RedPack100SimpleView")
...
my.addInstance(RedPack100SimpleCtrl)

function RedPack100SimpleCtrl:onCreate(params)
...
-- 提现按钮点击后，关闭后通知活动界面刷新
function RedPack100SimpleCtrl:btnTixianClicked()
    my.dataLink(cc.exports.DataLinkCodeDef.RED_PACK100_TI_XIAN_ON_BOUTED)
